...
if choice == true
    ...
    ImplResult=EvaluateClassification(Prediction, Prediction, validation_labels2, 6);
end
%Evaluate the results from the classification
OptimisedResult=EvaluateClassification ( Opt_Prediction, Opt_Score(:,2), validation_labels1, 1);
disp('done');
